		  ...
		  <div class="container">
				   <div class="ab-w3l-spa">
                    <br><br>
						   ...
						   <p class="about-para-w3ls">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Sed tempus vestibulum lacus blandit faucibus. Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, at imperdiet urna. Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, officiis dolorum. Cumque rem aliquid, quam at doloremque blanditiis. Aspernatur, obcaecati nam quaerat amet nemo sunt. Ad excepturi natus repudiandae beatae. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, corporis placeat itaque rem aliquid aut quo adipisci dolore, fuga praesentium laboriosam eligendi aliquam perferendis, maxime maiores in eius ipsa neque?</p>        
		          </div>
            </div>
        </div>
 	<!-- //about -->
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
          ...
          <li>
            <a class="nav-link" href="/abouts" style="color: white">About Us</a><br>
          </li>
          <li>
            <a class="nav-link" href="/services" style="color: white">Service</a><br>
          </li>
          <li>
            <a class="nav-link" href="/galleries" style="color: white">Gallery</a><br>
          </li>
          <li>
            <a class="nav-link" href="/testimonials" style="color: white">Testimonial</a><br>
          </li>
          <li>
